...
public class Employeecountbygendervtwo {
	...
	public static void main(String[] args) {
		...
		employeeCountByGender(input);

	}
	
	public static void employeeCountByGender (List<Employee>emps) {
		
		Map<String,Long>output = emps.stream().collect(Collectors.groupingBy(Employee::getGender,
				Collectors.counting()));
