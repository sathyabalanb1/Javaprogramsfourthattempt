...
public class Collectingandthenproducts {
	...
	public static void collectingAndThenProduct (List<Product>products) {
		
		String maxPriceProduct = products.stream().collect(Collectors.
